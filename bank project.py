...
def login_screen():
    ...
    def profile():
        ...
        ifrm.place(relx=.42,rely=.13,relwidth=.5,relheight=.72)
    ...
    def check():
        ...
        ckbl=cur.fetchone()
        ckblball=ckbl[5]
        lbl_ckbl=Label(ifrm,text='Your Current Balance is',font=('Arial',20,'bold'),bd=7,bg='#7FB3D5')
        lbl_ckbl.place(relx=.3,rely=.38)
        lbl_ckbl=Label(ifrm,text=f'[{ckblball}]',font=('Arial',20,'bold'),bd=7,bg='#7FB3D5')
        lbl_ckbl.place(relx=.55,rely=.52)
    ...
    btn_prof=Button(frm,text='Profile',font=('Arial',18,'bold'),bd=4,width=15,command=profile)
    btn_prof.place(relx=.15,rely=.13)
    
    btn_ckbal=Button(frm,text='Check balance',font=('Arial',18,'bold'),bd=4,width=15,command=check)
    btn_ckbal.place(relx=.15,rely=.26)
    
    btn_deposit=Button(frm,text='Deposit',font=('Arial',18,'bold'),bd=4,width=15,command=deposit)
    btn_deposit.place(relx=.15,rely=.39)
    
    btn_withdraw=Button(frm,text='Withdraw',font=('Arial',18,'bold'),bd=4,width=15,command=withdraw)
    btn_withdraw.place(relx=.15,rely=.52)
    
    btn_transfer=Button(frm,text='Transfer',font=('Arial',18,'bold'),bd=4,width=15,command=transfer)
    btn_transfer.place(relx=.15,rely=.65)
    
    btn_update=Button(frm,text='Update',font=('Arial',18,'bold'),bd=4,width=15,command=update)
    btn_update.place(relx=.15,rely=.78)
